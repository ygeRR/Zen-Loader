...
o	Automatically creates a backup of your original hosts file (hosts.ygeR) before making any changes.
o	Restores the original hosts file automatically when the application is closed.
...
Installation & Usage
1.	Place the ZenLoader executable in the same directory as your application.
2.	Launch ZenLoader as an Administrator.
3.	The tool will automatically:
o	Verify the hash of existing .exe files in the directory.
o	Back up your current hosts file.
o	Inject the blocklist.
4.	Once finished, closing the application will revert all changes to your system's hosts file.
Disclaimer
